...
CREATE TABLE `sucursal` (
  ...
  `cp_suc` varchar(50) NOT NULL,
  `telefono_suc` varchar(50) NOT NULL,
  PRIMARY KEY (`id_suc`)
...
INSERT INTO `sucursal` VALUES (1,'Los Elotitos de el Carmen N.L.','Vicente Suarez, El Jaral','67169','8312322563');
